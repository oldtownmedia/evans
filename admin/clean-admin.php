...
function setup() {
	...
	if ( 'on' === get_option( 'clean_admin_bar', 'on' ) ) {
	...
	add_action( 'add_meta_boxes', __NAMESPACE__ . '\\remove_seo_metabox', 11 );
	add_action( 'dashboard_glance_items', __NAMESPACE__ . '\\right_now_cpt_count' );
